...
$(function() {
    ...
    //Test suite that tests the menu visibility
    describe('The menu', function() {
        ...
        it('is hidden by default', function() {
            ...
            //():visible) turned out to not work asI thought
            //The reviewer hinted .hasClass, so I checked it out!
    ...
    //Test suite that tests number of entries within feed
    ...
    //Test suite that checks content when new feed is loaded
